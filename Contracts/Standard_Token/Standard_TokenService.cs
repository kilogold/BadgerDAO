...
using Contracts.Contracts.Standard_Token.ContractDefinition;

namespace Contracts.Contracts.Standard_Token
{
    public partial class Standard_TokenService
    {
        ...
        public Standard_TokenService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
